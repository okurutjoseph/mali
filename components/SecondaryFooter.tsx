    ...
    <>
      ...
      <section className="relative pt-20 pb-20">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h2 className="text-center text-[54px] font-[800] text-[#2c2c52] mb-12 pt-16">Marketing<br />Insights</h2>
          <BlogSection />
        </div>
      </section>

      {/* Newsletter Section */}
      <section className="py-20 bg-gradient-to-r from-[#251146] to-[#aa2b4c] text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h4 className="text-[40px] font-bold mb-8 leading-tight">
              Interested In Getting Insights And Free Resources<br />
              On Digital Marketing? Subscribe Below
            </h4>
            <form className="flex flex-col md:flex-row gap-4 justify-center">
              <input
                type="text"
                placeholder="Name"
                className="px-6 py-4 bg-transparent border border-white rounded-none text-white placeholder-white flex-1 focus:outline-none"
              />
              <input
                type="email"
                placeholder="Email"
              ...
              <button
                type="submit"
                className="px-8 py-4 bg-white text-black font-semibold hover:bg-opacity-90 transition-all duration-300"
              >
                SUBMIT
              </button>
            </form>
