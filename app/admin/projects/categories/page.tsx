...
const ProjectCategoriesPage = () => {
  ...
  const [isEditing, setIsEditing] = useState<Id<"projectCategories"> | null>(null);
  ...
  const handleUpdate = async (categoryId: Id<"projectCategories">) => {
    try {
  ...
  const handleDelete = async (categoryId: Id<"projectCategories">) => {
